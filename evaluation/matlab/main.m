...
elseif filter == 1 && original == 0
    base_dir = '/home/mamlpm/Documentos/TrabajoFinMaster/Results/filtradosNuevo/';
else
    base_dir = '/home/mamlpm/Documentos/TrabajoFinMaster/Results/noFiltrados/';
end
gt_neigh = 40;
compensate = false;
...
for i = 1:agentsNumber
    plot(PR_L6I(i).R, PR_L6I(i).P, 'color', rand(1,3), 'DisplayName', num2str(i));
end
legend show
xlabel('Recall');
ylabel('Precision');
